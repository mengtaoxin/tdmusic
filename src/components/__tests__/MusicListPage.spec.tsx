...
describe('MusicListPage', () => {
  ...
  it('hides play-all actions when the catalog is empty', () => {
    renderWithProviders(<MusicListPage />)
  ...
  it('plays the full catalog in order or shuffled from the page actions', async () => {
